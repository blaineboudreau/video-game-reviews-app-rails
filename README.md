...
[ ] ———Simple Solitaire App———

	—CSS—
		-general styling-
		-cards with faces added to the game-
...
[ ] ———Include Completed Projects Links With Thumbnails———

[ ] ———Touch Up Resume———(in progress)
...
[ DAILY ] ———Dev Jobs———
	...
	—Apply 2 per day and more as portolfio is finished —

		- insert dev companies here
